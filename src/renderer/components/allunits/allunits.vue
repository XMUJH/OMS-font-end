...
<div>
  <el-container>
    ...
    <el-button type="primary" style="margin:0 0 10px 0;" round size="mini" v-if="companyOrMember==0">添加外包单位</el-button>
      ...
      <el-table :data="tableData" border style="width:650px" height="500" header-cell-style="color:#000000;background-color:#f3f3f3" @cell-click="handleClick($event)" v-if="companyOrMember==0">
