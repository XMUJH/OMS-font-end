...
export default {
  ...
  methods: {
    ...
    getIn (event) {
      ...
      this.allTasks = [{name: '智慧家居平台', percentage: 20, color: '#f33232'}, {name: '智能外包管理平台', percentage: 80, color: '#2cd64d'}, {name: '智慧家居平台', percentage: 0, color: '#f33232'}]
    },
    getdata (evt) {
